...
const [url,setUrl]=useState('wss://synkit-backend-production.up.railway.app/json')
...
const Draw=e=>{
    ...
    return (
        <div className="h-screen w-screen  bg-[#A7A7A7] flex flex-wrap justify-center items-center ">

            <canvas  className=" bg-white border border-black  "
            ref={canvasRef}
