                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex space-x-4">
                                ...
                                <a href="#"
                                   className="text-black-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Share</a>

                                <a href="#"
                                   className="text-black-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Team</a>

                                <a href="#"
                                   className="text-black-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Call</a>
                            </div>
                        </div>
                    </div>
                    <div
